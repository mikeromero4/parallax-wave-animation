...
export default props => {
  let{width,height,time}=props
  let waveProperties = calculateWaveProperties({...props.settings,width,height,time})
...
function calculateIconPosition ({ time, index, settings }){
    ...
    let y = Math.sin(waveX) * amplitude       
           // the y coordinate of the sine wave
